...
case class TitleMessage(override val id : Long, val s: String) extends SombreroMessage(id) //maybe add some sort of parameter that allows the receiver to identify the changed field
